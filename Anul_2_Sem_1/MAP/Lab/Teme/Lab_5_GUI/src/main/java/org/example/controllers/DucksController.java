...
public class DucksController implements Observer {
    ...
    /**
     * Seteaza serviciul utilizator si initializeaza componentele UI.
     *
     * @param service serviciul utilizator
     * @param cardService serviciul carduri
     * @param friendshipService serviciul prietenii
     * @param messageService serviciul mesaje
     */
    public void setService(UserService service, CardService cardService, FriendshipService friendshipService, MessageService messageService) {
    ...
    private void goBack() {
        try {
            ...
            ctrl.setServices(service, friendshipService, cardService, messageService);
