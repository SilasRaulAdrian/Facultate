...
public class MessagesController {
    ...
    public void openChat() {
        ...
        try {
            ...
            String title = selected.size() == 1
                    ? "Chat with " + selected.get(0).getUsername()
                    : "Group chat (" + selected.size() + " users)";
    ...
    private void goBack() {
        try {
            ...
            mainController.setServices(userService, friendshipService, cardService, messageService);
